...
static const char *fonts[]          = { "xft:Monospace:pixelsize=14:style=regular:antialias=true" };
...
static const char col_normborder[]  = "#353535";
static const char col_selborder[]   = "#aaaaaa";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_normborder },
...
static const Rule rules[] = {
	...
	{ "Firefox",  NULL,       NULL,       1 << 8,       0,           -1 },
	{ NULL,       "emacs",    NULL,       1,            0,           -1 },
	{ "Gnome-terminal",  NULL,NULL,       1 << 2,       0,           -1 },
	{ NULL,       "rxvt",     NULL,       1 << 2,       0,           -1 },
    */
};
...
static Key keys[] = {
	...
	{ MOD4KEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MOD4KEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	...
	{ MOD4KEY|ShiftMask,             XK_c,      killclient,     {0} },
